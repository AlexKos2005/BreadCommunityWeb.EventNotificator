...
namespace BreadCommunityWeb.EventNotificator.Server.Controllers
{
    ...
    [ApiController]
    public class ReportNotificatorServiceController : ControllerBase
    {
        private readonly IReportNotificatorService _notificatorService;
        private readonly IConfigService<ReportNotificatorServiceConfigDto, ReportNotificatorServiceConfigResponseDto, int> _configService;
        public ReportNotificatorServiceController(
            IReportNotificatorService notificatorService, 
            IConfigService<ReportNotificatorServiceConfigDto, ReportNotificatorServiceConfigResponseDto, int> configService)
        {
        ...
        public async Task<ActionResult<ReportNotificatorServiceConfigResponseDto>> GetServiceConfig()
        {
        ...
        public async Task<ActionResult> PutServiceConfig(ReportNotificatorServiceConfigRequestDto config)
        {
